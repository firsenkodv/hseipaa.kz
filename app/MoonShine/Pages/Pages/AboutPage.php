                ...
                Box::make([
                    Tabs::make([
                        ...
                        Tab::make('Блоки', [
                            ...
                            Collapse::make('Платформа (about-platform)', [
                                Text::make('Заголовок', 'platform_title')
                                    ->default('Удобная платформа для обучения'),
                                Textarea::make('Описание', 'platform_desc')
                                    ->default('Современный личный кабинет с интуитивным интерфейсом. Управляйте своим обучением, отслеживайте прогресс и общайтесь с преподавателями в одном месте.'),
                                Json::make('Возможности платформы', 'platform_features')->fields([
                                    Text::make('Заголовок', 'title'),
