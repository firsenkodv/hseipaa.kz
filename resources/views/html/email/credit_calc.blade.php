...
@section('title', 'Заявка — расчёт кредита на обучение')

@section('description', 'Пользователь рассчитал кредит и оставил заявку. Свяжитесь с ним как можно скорее.')

@section('content')
    @foreach($data as $label => $value)
        <table role="presentation" border="0" cellpadding="0" cellspacing="0" width="100%" style="margin-bottom:10px;">
            <tr>
                <td style="width:160px; padding:8px 12px 8px 0; vertical-align:top;">
